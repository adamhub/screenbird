...
public final class PerspectiveTransform implements Cloneable, Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m00) ^ (Double.doubleToLongBits(this.m00) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m01) ^ (Double.doubleToLongBits(this.m01) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m02) ^ (Double.doubleToLongBits(this.m02) >>> 32));
        ...
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m20) ^ (Double.doubleToLongBits(this.m20) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m21) ^ (Double.doubleToLongBits(this.m21) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.m22) ^ (Double.doubleToLongBits(this.m22) >>> 32));
        return hash;
    }
}
