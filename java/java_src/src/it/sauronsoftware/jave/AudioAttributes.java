...
public class AudioAttributes implements Serializable {
    ...
    /**
     * Allows to attach an external audio file to a video.
     */
    ...
    public File getExternalAudioFile() {
        return externalAudioFile;
    }

    public void setExternalAudioFile(File externalAudioFile) {
        this.externalAudioFile = externalAudioFile;
    }
